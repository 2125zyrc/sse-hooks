...
__export(index_exports, {
  ...
  useChat: () => useChat,
  useChatWithEvents: () => useChatWithEvents,
  useSSE: () => useSSE
});
...
function useMemoizedFn(fn) {
  ...
  fnRef.current = fn;
  const memoizedFn = (0, import_react.useCallback)((...args) => {
...
function useSSE(url, options = {}) {
  ...
  const [readyState, setReadyState] = (0, import_react2.useState)(3 /* Closed */);
  ...
  const pluginHooksRef = (0, import_react2.useRef)([]);
  const pluginCtxRef = (0, import_react2.useRef)(null);
  const pluginHeadersRef = (0, import_react2.useRef)({});
...
function useChatWithEvents(options) {
  ...
  const [thinkingText, setThinkingText] = (0, import_react4.useState)("");
  const plugins = [
